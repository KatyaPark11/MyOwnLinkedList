    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            List<MenuItem> items = new()
            {
                ...
                new MenuItem("Lab_3", "ListMethodsCaller", "HeadToTail", "Перенести первый элемент списка в начало"),
                new MenuItem("Lab_3", "ListMethodsCaller", "TailToHead", "Перенести последний элемент списка в конец"),
                new MenuItem("Lab_3", "ListMethodsCaller", "RemoveDuplicates", "Удалить все дубликаты"),
                new MenuItem("Lab_3", "ListMethodsCaller", "InsertInSortedInAcsOrderList", "Вставить элемент в отсортированный по неубыванию список"),
