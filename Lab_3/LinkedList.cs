...
namespace Lab_3
{
    ...
    public class LinkedList<T>
    {
        ...
        /// <summary>
        /// Метод, возвращающий число различных элементов списка.
        /// </summary>
        ...
        /// <summary>
        /// Метод, проверяющий, является ли список отсортированным по не убыванию.
        /// </summary>
        ...
        /// <summary>
        /// Метод, добавляющий в отсортированный по не убыванию список указанный элемент без нарушения сортировки.
        /// </summary>
        /// <param name="data">Значение добавляемого элемента.</param>
        ...
        /// <summary>
        /// Метод, вставляющий элемент с указанным значением перед первым вхождением элемента с заданным значением.
        /// </summary>
        /// <param name="insertData">Значение вставляемого элемента.</param>
